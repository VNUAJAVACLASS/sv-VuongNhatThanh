...
public class UserSubject {
	...
	public UserSubject(String userCode, String subjectCode, float attendanceExamMark, float midExamMark1, float midExamMark2, float midExamMark3, float finalExamMark) {
