	...
	public List<LichHoc> docThoiKhoaBieu(String filePath) {
		...
		try {
			...
			for (Element row : rows) {
				...
				String thu = cells.get(baseIndex).text().trim();
				...
				LichHoc lichHoc = new LichHoc(maMon, tenMon, nhomTo, soTinChi, lop, thu, tietBatDau, soTiet, phong,giangVien, thoiGianHoc);
