...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
	...
	protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain)
		...
		// Kiểm tra dk: SecurityContextHolder.getContext().getAuthentication() == null
		// -> Để tránh xác thực
		// lại nhiều lần với mỗi request vì request có thể qua nhiều filter hoặc là
		// request nội bộ đã xác thực
		...
		// filter này chỉ có nhiệm vụ kiểm tra jwtToken ghi vào vùng nhớ tạm
